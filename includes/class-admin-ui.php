 ...
 * Version 0.1 with Device Mockups and AJAX Updates
 */
...
class SRP_Admin_UI {
  ...
  /**
   * Modern dashboard page with v0.1 features
   */
  public function render_main_page() {
    ...
    $device_options = SRP_Device_Mockups::get_device_options();
      ...
      <div class="srp-header">
        <div class="srp-header-content">
          <div class="srp-header-text">
            ...
            <p class="srp-subtitle"><?php _e('Create beautiful scrolling videos with device mockups', 'screen-recorder-pro'); ?></p>
          </div>
              ...
              <form id="srp-recording-form" class="srp-form">
                ...
                <div class="srp-form-row">
                  ...
                  <div class="srp-form-group">
                    ...
                    <select id="srp-viewport" class="srp-select">
                      ...
                      <option value="1280x720">1280×720 (Desktop)</option>
                      <option value="834x1194">834×1194 (iPad Pro)</option>
                      <option value="820x1180">820×1180 (iPad Air)</option>
                      <option value="912x1368">912×1368 (Surface Pro)</option>
                      <option value="393x852">393×852 (iPhone 15 Pro)</option>
                      <option value="430x932">430×932 (iPhone 15 Pro Max)</option>
                      <option value="384x854">384×854 (Samsung S24)</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="srp-form-group">
                  <label for="srp-device" class="srp-label">
                    ...
                    <?php _e('Device Frame', 'screen-recorder-pro'); ?>
                    <span class="srp-badge srp-badge-new">NEW</span>
                  </label>
                  <select id="srp-device" class="srp-select">
                    <?php foreach ($device_options as $device_key => $device_info): ?>
                      <option value="<?php echo esc_attr($device_key); ?>">
                        <?php echo esc_html($device_info['name']); ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
                  <div class="srp-help-text"><?php _e('Choose a device frame to showcase your recording', 'screen-recorder-pro'); ?></div>
                </div>
  ...
  /**
   * All Recordings page with device mockup support
   */
      ...
      <div class="srp-header">
        <div class="srp-header-content">
          <div class="srp-header-text">
            ...
            <p class="srp-subtitle"><?php _e('Manage and share your screen recordings with device frames', 'screen-recorder-pro'); ?></p>
          </div>
      ...
      <?php else: ?>
        <div class="srp-recordings-grid">
          <?php foreach ($recordings as $recording): ?>
            ...
            $device_shortcode = "[screen_recording id=\"{$recording->id}\" device=\"iphone_15_pro\"]";
            ?>
            <div class="srp-recording-card">
              ...
              <div class="srp-recording-content">
                ...
                <div class="srp-shortcode-section">
                  <label class="srp-shortcode-label"><?php _e('Basic Shortcode', 'screen-recorder-pro'); ?></label>
                ...
                <div class="srp-shortcode-section">
                  <label class="srp-shortcode-label">
                    <?php _e('With Device Frame', 'screen-recorder-pro'); ?>
                    <span class="srp-badge srp-badge-new">NEW</span>
                  </label>
                  <div class="srp-shortcode-input-group">
                    <input type="text" class="srp-shortcode-input"
                           value="<?php echo esc_attr($device_shortcode); ?>"
                           readonly onclick="this.select()">
                    <button type="button" class="srp-copy-btn"
                            data-shortcode="<?php echo esc_attr($device_shortcode); ?>">
                      <span class="dashicons dashicons-admin-page"></span>
                    </button>
                  </div>
                </div>
          ...
          $.post(ajaxurl, {
            ...
            if (response.success) {
              $card.fadeOut(300, function() {
                $(this).remove();
                updateRecordingCount(); // Update count after deletion
              });
            } else {
  ...
  public function save_premium_settings() {
    if (!wp_verify_nonce($_POST['srp_premium_nonce'], 'srp_save_premium_settings')) {
    ...
    wp_redirect(admin_url('admin.php?page=screen-recorder-premium&updated=1'));
    exit;
  }
  ...
  private function render_modern_styles() {
    ...
    .srp-input:focus, .srp-select:focus {
      outline: none;
      border-color: #667eea;
